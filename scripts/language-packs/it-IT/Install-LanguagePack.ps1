<#
.SYNOPSIS
    Installs the Italian language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the it-IT language pack via Install-Language, sets it as the
