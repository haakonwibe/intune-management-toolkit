<#
.SYNOPSIS
    Installs the Turkish language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the tr-TR language pack via Install-Language, sets it as the
