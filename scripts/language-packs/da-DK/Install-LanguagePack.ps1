<#
.SYNOPSIS
    Installs the Danish language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the da-DK language pack via Install-Language, sets it as the
