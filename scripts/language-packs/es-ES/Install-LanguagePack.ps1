<#
.SYNOPSIS
    Installs the Spanish language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the es-ES language pack via Install-Language, sets it as the
