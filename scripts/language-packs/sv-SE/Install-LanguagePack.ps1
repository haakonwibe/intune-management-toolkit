<#
.SYNOPSIS
    Installs the Swedish language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the sv-SE language pack via Install-Language, sets it as the
