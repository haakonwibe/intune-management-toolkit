<#
.SYNOPSIS
    Installs the Dutch language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the nl-NL language pack via Install-Language, sets it as the
