<#
.SYNOPSIS
    Installs the Croatian language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the hr-HR language pack via Install-Language, sets it as the
