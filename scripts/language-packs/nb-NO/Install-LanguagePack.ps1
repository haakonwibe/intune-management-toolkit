<#
.SYNOPSIS
    Installs the Norwegian (Bokmål) language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the nb-NO language pack via Install-Language, sets it as the
