<#
.SYNOPSIS
    Installs the Albanian language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the sq-AL language pack via Install-Language, sets it as the
