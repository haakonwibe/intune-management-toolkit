<#
.SYNOPSIS
    Installs the French language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the fr-FR language pack via Install-Language, sets it as the
