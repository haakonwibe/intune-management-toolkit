<#
.SYNOPSIS
    Installs the German language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the de-DE language pack via Install-Language, sets it as the
