<#
.SYNOPSIS
    Installs the Portuguese language pack and sets it as the Windows UI language.

.DESCRIPTION
    Downloads and installs the pt-PT language pack via Install-Language, sets it as the
